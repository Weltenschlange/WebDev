...
console.log("---------------------------------------------")
console.log("Wort: Project")
console.log("English: " + translation.get("Project")[languages.get("EN")])
console.log("Deutsch: " + translation.get("Project")[languages.get("DE")])
console.log("Wort: Comment")
console.log("English: " + translation.get("Comment")[languages.get("EN")])
console.log("Deutsch: " + translation.get("Comment")[languages.get("DE")])
console.log("---------------------------------------------")